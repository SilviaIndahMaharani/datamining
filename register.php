...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($first_name) || empty($last_name) || empty($email) || empty($password) || empty($repeat_password)) {
        ...
        $sql = "INSERT INTO data_user (first_name, last_name, email, password) VALUES ('$first_name', '$last_name', '$email', '$hashed_password')";

        if ($koneksi->query($sql) === TRUE) {
            header("Location: login.php"); // Setelah berhasil registrasi, arahkan ke halaman login
            exit();
        } else {
            $error_message = "Terjadi kesalahan: " . $koneksi->error;
        }
    }
}
...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body" style="padding: 110px;">
